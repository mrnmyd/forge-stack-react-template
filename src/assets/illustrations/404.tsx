        ...
        <div>
            <svg xmlns="http://www.w3.org/2000/svg" className="h-90" viewBox="0 0 500 500">
                <g id="freepik--background-simple--inject-15">
                    <path
                        d="M418.91,125.42c39.29,31.84,35.52,75.55,1.84,100.47-16.15,12-48.66,9.64-67.16,18.07-24.13,11-36.38,31.39-54.87,47.67-46,40.48-61,20.47-113.32,21-36.81.37-71.81,31.4-108.7,10.09-45.07-26-17.16-78.17,19.65-98.3C138.62,201.3,112,147,172.83,106.91,232.65,67.52,360.56,76.81,418.91,125.42Z"
                        fill="currentColor" className="text-primary"></path>
                    <path
                        d="M418.91,125.42c39.29,31.84,35.52,75.55,1.84,100.47-16.15,12-48.66,9.64-67.16,18.07-24.13,11-36.38,31.39-54.87,47.67-46,40.48-61,20.47-113.32,21-36.81.37-71.81,31.4-108.7,10.09-45.07-26-17.16-78.17,19.65-98.3C138.62,201.3,112,147,172.83,106.91,232.65,67.52,360.56,76.81,418.91,125.42Z"
                        fill="currentColor" className="text-background opacity-90"></path>
                </g>
                <g id="freepik--Shadow--inject-15">
                    <ellipse id="freepik--path--inject-15" cx="250" cy="416.24" rx="193.89" ry="11.32"
                        fill="currentColor" className="text-muted"></ellipse>
                </g>
                <g id="freepik--oops--inject-15">
                    <path
                        ...
                        fill="currentColor" className="text-muted-foreground"></path>
                    <path
                ...
                <g id="freepik--error-404--inject-15">
                    <path
                    ...
                    <path
                        ...
                        fill="currentColor" className="text-primary opacity-30"></path>
                    <path
                    ...
                    <path
                        ...
                        fill="currentColor" className="text-muted-foreground"></path>
                    <path d="M414.83,153.37a.82.82,0,0,1-1.64-.06.82.82,0,0,1,1.64.06Z" fill="currentColor"
                        className="text-muted-foreground"></path>
                    <path d="M411.5,170.67a.82.82,0,1,1-.79-.85A.82.82,0,0,1,411.5,170.67Z" fill="currentColor"
                        className="text-muted-foreground"></path>
                    <path
                        d="M408.17,188a.82.82,0,0,1-.85.79.81.81,0,0,1-.79-.84.82.82,0,0,1,.85-.8A.83.83,0,0,1,408.17,188Z"
                        fill="currentColor" className="text-muted-foreground"></path>
                    <path d="M401.61,206a.82.82,0,0,1-1.63,0,.82.82,0,1,1,1.63,0Z" fill="currentColor"
                        className="text-muted-foreground"></path>
                    <path d="M401.5,222.57a.81.81,0,0,1-.85.79.82.82,0,1,1,.85-.79Z" fill="currentColor"
                        className="text-muted-foreground"></path>
                    ...
                    <path d="M394.84,257.17a.83.83,0,0,1-.85.8.82.82,0,0,1-.79-.85.82.82,0,0,1,1.64.05Z"
                        fill="currentColor" className="text-muted-foreground"></path>
                    <path d="M391.5,274.48a.82.82,0,1,1-.79-.85A.81.81,0,0,1,391.5,274.48Z" fill="currentColor"
                        className="text-muted-foreground"></path>
                    <path
                ...
                <g id="freepik--Character--inject-15">
                    <path
                        ...
                        fill="currentColor" className="text-muted-foreground"></path>
                    <circle cx="251.51" cy="273" r="18.38" fill="currentColor" className="text-background"></circle>
                    <path
                    ...
                    <path
                        ...
                        fill="currentColor" className="text-background opacity-30"></path>
                    <path
                    ...
                    <polygon points="303.47 412.24 185.67 408.33 180.78 294.11 319.89 297.22 303.47 412.24"
                        fill="currentColor" className="text-primary"></polygon>
                    <path
                    ...
                    <path
                        ...
                        fill="currentColor" className="text-muted-foreground"></path>
                    <circle cx="209.88" cy="297.88" r="0.82" fill="currentColor" className="text-muted-foreground"></circle>
                ...
                <g id="freepik--robot-parts--inject-15">
                    <path
                    ...
                    <polygon
                        ...
                        fill="currentColor" className="text-muted-foreground"></polygon>
                    ...
                    <rect x="339.07" y="411.71" width="1.37" height="10.1"
                        transform="translate(469.33 938.61) rotate(-154.76)" fill="currentColor"
                        className="text-muted-foreground"></rect>
                </g>
            </svg>
        </div>
    )
