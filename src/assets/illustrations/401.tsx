export function UnauthorizedIllustration() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" className='h-90' viewBox="0 0 500 500">
            <g id="freepik--background-complete--inject-45">
                <circle cx="425.75" cy="143.5" r="44.03" fill="currentColor" className="text-background"></circle>
                <path
                    ...
                    fill="currentColor" className="text-muted"></path>
                <path
            ...
            <g id="freepik--Plant--inject-45">
                <path
                    ...
                    fill="currentColor" className="text-primary"></path>
                <g className="opacity-30">
                    <path
                        d="M61,446.2c.59-2.29-.91-4.58-2.59-6.24s-3.69-3.15-4.56-5.34c-1.42-3.55.49-8.15-1.93-11.11-1.42-1.75-4-2.33-5.23-4.19A9.61,9.61,0,0,1,45.53,416a33.66,33.66,0,0,0-8.41-15.73,29.47,29.47,0,0,0,3.3,15.16c1,1.86,2.18,3.68,2.51,5.76.52,3.38-1.36,6.85-.53,10.17,1,3.79,5.21,6.33,5.41,10.23.17,3.3-2.71,6.2-2.49,9.5A8.81,8.81,0,0,0,46.79,455c2.55,4.24,6.3,7.16,12,7.07l7,.24Z"></path>
                </g>
                <path
            ...
            <g id="freepik--Device--inject-45">
                <rect x="140.19" y="80.02" width="266.62" height="382.62" rx="11.55" fill="currentColor" className="text-foreground"></rect>
                <rect x="148.6" y="106.2" width="249.81" height="319.54" fill="currentColor" className="text-background"></rect>
                <circle cx="273.5" cy="443.42" r="10.23"
                    transform="translate(-221.06 607.21) rotate(-76.66)" fill="currentColor" className="text-muted-foreground"></circle>
                <rect x="233.35" y="91.04" width="80.3" height="4.23" rx="1.22" fill="currentColor" className="text-muted-foreground"></rect>
                <path
                ...
                <path
                    ...
                    fill="currentColor" className="text-background"></path>
                <path d="M262.14,383h.59l0,5.91h-.6Z" fill="currentColor" className="text-background"></path>
                ...
                <rect x="202.56" y="253.06" width="35.64" height="6.54"
                    transform="matrix(1, 0, 0, 1, 1.19, -1.01)" fill="currentColor" className="text-muted"></rect>
                <path
                ...
                <rect x="202.29" y="315.3" width="35.64" height="6.54"
                    transform="translate(1.47 -1.01) rotate(0.26)" fill="currentColor" className="text-muted"></rect>
                <path
                ...
                <rect x="212.12" y="278.28" width="65.19" height="6.11"
                    transform="translate(1.3 -1.13) rotate(0.26)" fill="currentColor" className="text-muted"></rect>
                ...
                <path d="M235.72,344.27a2.86,2.86,0,1,1-2.84-3A2.94,2.94,0,0,1,235.72,344.27Z"
                    fill="currentColor" className="text-muted"></path>
                <path d="M244.55,344.31a2.86,2.86,0,1,1-2.84-3.05A3,3,0,0,1,244.55,344.31Z"
                    fill="currentColor" className="text-muted"></path>
                <path d="M253.38,344.35a2.86,2.86,0,1,1-2.84-3.05A3,3,0,0,1,253.38,344.35Z"
                    fill="currentColor" className="text-muted"></path>
                <path d="M262.21,344.39a2.86,2.86,0,1,1-2.84-3.05A3,3,0,0,1,262.21,344.39Z"
                    fill="currentColor" className="text-muted"></path>
                <path d="M271,344.43a2.86,2.86,0,1,1-2.84-3.05A3,3,0,0,1,271,344.43Z" fill="currentColor" className="text-muted"></path>
                ...
                <circle cx="279.8" cy="181.75" r="48.88" transform="translate(-46.57 251.08) rotate(-45)"
                    fill="currentColor" className="text-muted"></circle>
                <path
            ...
            <g id="freepik--Sign--inject-45">
                <rect x="103.83" y="229.31" width="12.88" height="233.26" fill="currentColor" className="text-foreground"></rect>
                <rect x="100.25" y="229.31" width="12.88" height="233.26" fill="currentColor" className="text-muted-foreground"></rect>
                <path
                    ...
                    fill="currentColor" className="text-primary"></path>
                <g id="freepik--4mamg4tif--inject-45">
                    <path
                ...
                <path
                    ...
                    fill="currentColor" className="text-background"></path>
                <path d="M144.39,186.71v34.75h-8V193.17H129.4v-6.46Z" fill="currentColor" className="text-background"></path>
                <path d="M98,176v1.5H89.28v-12h8.48v1.49H91v3.69h6v1.46H91V176Z" fill="currentColor" className="text-background"></path>
                <path
                ...
                <path
                    ...
                    fill="currentColor" className="text-background"></path>
                <path
                    d="M127.39,230.33a.87.87,0,1,1,.87.83A.83.83,0,0,1,127.39,230.33Zm.22,2.2h1.29v7.11h-1.29Z"
                    fill="currentColor" className="text-background"></path>
                <path d="M136.63,238.58v1.06h-6v-.83l4.2-5.22h-4.12v-1.06h5.77v.84l-4.2,5.21Z"
                    fill="currentColor" className="text-background"></path>
                <path
            ...
            <g id="freepik--Padlock--inject-45">
                <path
                ...
                <path d="M317.8,239l6-2.79a12.63,12.63,0,0,0-1.48-1.56L316.15,238S317.64,238.54,317.8,239Z"
                    fill="currentColor" className="text-muted"></path>
                <path d="M320.33,246.5l6.34-.11a27.45,27.45,0,0,0-.06-3.75l-6.13,2.87Z" fill="currentColor" className="text-muted"></path>
                <path
                    d="M325.32,238.6a13.51,13.51,0,0,0-18.15-6l-18.34,9.24a13.51,13.51,0,0,0-6,18.14h0A13.51,13.51,0,0,0,301,266l18.34-9.24A13.52,13.52,0,0,0,325.32,238.6Zm-8.75,12.48-18.2,9.17a7.2,7.2,0,1,1-6.48-12.87l18.2-9.17a7.2,7.2,0,1,1,6.48,12.87Z"
                    fill="none"></path>
                <path
                ...
                <path d="M376.4,210l6-2.8a13.33,13.33,0,0,0-1.47-1.55l-6.14,3.37S376.24,209.57,376.4,210Z"
                    fill="currentColor" className="text-muted"></path>
                <path d="M378.93,217.54l6.34-.11a27.18,27.18,0,0,0,0-3.76l-6.13,2.87Z" fill="currentColor" className="text-muted"></path>
                <path
                    d="M383.92,209.64a13.5,13.5,0,0,0-18.14-6l-18.34,9.24a13.51,13.51,0,0,0-6,18.15h0a13.51,13.51,0,0,0,18.14,6l18.35-9.24A13.5,13.5,0,0,0,383.92,209.64Zm-8.74,12.47L357,231.28a7.21,7.21,0,1,1-6.49-12.87l18.2-9.17a7.21,7.21,0,0,1,6.49,12.87Z"
                    fill="none"></path>
                <path
                ...
                <path
                    ...
                    fill="currentColor" className="text-muted"></path>
                <path
                    d="M201.83,294.49l6-2.79a13.55,13.55,0,0,0-1.48-1.56l-6.14,3.37S201.67,294,201.83,294.49Z"
                    fill="currentColor" className="text-muted"></path>
                <path d="M204.36,302l6.34-.11a27,27,0,0,0,0-3.75L204.52,301Z" fill="currentColor" className="text-muted"></path>
                <path
                    d="M209.36,294.1a13.53,13.53,0,0,0-18.15-6l-18.34,9.24a13.51,13.51,0,0,0-6,18.15h0a13.51,13.51,0,0,0,18.15,6l18.34-9.24A13.53,13.53,0,0,0,209.36,294.1Zm-8.75,12.48-18.2,9.17a7.2,7.2,0,1,1-6.48-12.87l18.2-9.17a7.2,7.2,0,0,1,6.48,12.87Z"
                    fill="none"></path>
                <path
                ...
                <path
                    ...
                    fill="currentColor" className="text-muted"></path>
                <path
                    d="M260.44,265.52l6-2.79a13.06,13.06,0,0,0-1.47-1.56l-6.14,3.38S260.28,265.07,260.44,265.52Z"
                    fill="currentColor" className="text-muted"></path>
                <path d="M263,273l6.34-.12a25.88,25.88,0,0,0-.06-3.75L263.13,272Z" fill="currentColor" className="text-muted"></path>
                <path
                    d="M268,265.14a13.5,13.5,0,0,0-18.14-6l-18.34,9.24a13.5,13.5,0,0,0-6,18.14h0a13.5,13.5,0,0,0,18.14,6L262,283.28A13.51,13.51,0,0,0,268,265.14Zm-8.74,12.47L241,286.78a7.21,7.21,0,1,1-6.49-12.87l18.2-9.17a7.21,7.21,0,0,1,6.49,12.87Z"
                    fill="none"></path>
                <path
                ...
                <g className="opacity-40">
                    <path
                        d="M282.94,273.23a13.34,13.34,0,0,0-18.58-3.13l-25.43,18.08-3.32-4.67L261,265.42a19.09,19.09,0,0,1,26.57,4.49"></path>
                </g>
                <rect x="228.06" y="274.86" width="32.95" height="51.36" rx="5.73"
                    transform="translate(-128.91 197.3) rotate(-35.41)" fill="currentColor" className="text-primary"></rect>
                <path
                ...
                <g className="opacity-50">
                    <path
                        d="M250.52,301.55a4.29,4.29,0,1,0-6.51-2.07l-5.24,3.72,1.36,1.91,5.23-3.72A4.27,4.27,0,0,0,250.52,301.55Z"></path>
                </g>
                <path
                ...
                <path
                    ...
                    fill="currentColor" className="text-muted"></path>
                <path
                    d="M321.17,401.43l-2.27-6.05a12.63,12.63,0,0,1,2.1-.08l2,6.57S321.59,401.22,321.17,401.43Z"
                    fill="currentColor" className="text-muted"></path>
                <path d="M314.24,405l-4.36-4.43a27.35,27.35,0,0,1,2.61-2.59l2.33,6.21Z" fill="currentColor" className="text-muted"></path>
                <path
                    d="M308,413.15l6.4,18.73a13.26,13.26,0,0,0,16.82,8.25h0a13.25,13.25,0,0,0,8.25-16.83L333,404.25a13.25,13.25,0,0,0-18.22-7.68A13.46,13.46,0,0,0,308,413.15Zm11.12-11.65a7.22,7.22,0,0,1,8,4.88l6.31,18.44a7.25,7.25,0,0,1-3.5,8.89,7.08,7.08,0,0,1-9.79-4.06l-6.46-18.91A7.07,7.07,0,0,1,319.15,401.5Z"
                    fill="none"></path>
                <path
                ...
                <path
                    ...
                    fill="currentColor" className="text-muted"></path>
                <path
                    d="M256.91,220.94l-2.26-6.05a12.47,12.47,0,0,1,2.09-.08l2,6.57S257.34,220.73,256.91,220.94Z"
                    fill="currentColor" className="text-muted"></path>
                <path d="M250,224.47,245.62,220a25.48,25.48,0,0,1,2.62-2.59l2.32,6.21Z" fill="currentColor" className="text-muted"></path>
                <path
                    d="M243.66,232.33l6.51,19A13.25,13.25,0,0,0,267,259.63h0a13.26,13.26,0,0,0,8.25-16.82l-6.52-19.05a13.25,13.25,0,0,0-25.07,8.57Zm10.22-11.05a7.05,7.05,0,0,1,9,4.4l6.47,18.9A7.06,7.06,0,1,1,256,249.15l-6.47-18.9A7.07,7.07,0,0,1,253.88,221.28Z"
                    fill="none"></path>
                <path
                ...
                <path
                    ...
                    fill="currentColor" className="text-muted"></path>
                <path
                    d="M235.71,160.45l-2.27-6a12.63,12.63,0,0,1,2.1-.08l2,6.57S236.13,160.24,235.71,160.45Z"
                    fill="currentColor" className="text-muted"></path>
                <path d="M228.79,164l-4.37-4.43A26.2,26.2,0,0,1,227,157l2.33,6.21Z" fill="currentColor" className="text-muted"></path>
                <path
                    d="M222.46,171.84l6.51,19a13.24,13.24,0,0,0,16.82,8.25h0A13.24,13.24,0,0,0,254,182.32l-6.51-19a13.25,13.25,0,0,0-25.07,8.57Zm10.22-11.05a7.05,7.05,0,0,1,9,4.4l6.46,18.9a7.06,7.06,0,1,1-13.36,4.57l-6.47-18.9A7.07,7.07,0,0,1,232.68,160.79Z"
                    fill="none"></path>
                <path
                ...
                <path
                    ...
                    fill="currentColor" className="text-muted"></path>
                <path
                    d="M216.82,106.43l-2.27-6.05a12.63,12.63,0,0,1,2.1-.08l2,6.58S217.25,106.22,216.82,106.43Z"
                    fill="currentColor" className="text-muted"></path>
                <path d="M209.9,110l-4.37-4.42a27.16,27.16,0,0,1,2.61-2.6l2.33,6.22Z" fill="currentColor" className="text-muted"></path>
                <path
                    d="M203.57,117.82l6.51,19.06a13.26,13.26,0,0,0,16.83,8.25h0a13.25,13.25,0,0,0,8.24-16.83l-6.51-19.05a13.25,13.25,0,0,0-25.07,8.57Zm10.22-11a7.07,7.07,0,0,1,9,4.4l6.47,18.91a7.06,7.06,0,1,1-13.37,4.57l-6.47-18.91A7.07,7.07,0,0,1,213.79,106.77Z"
                    fill="none"></path>
                <path
                ...
                <path
                    ...
                    fill="currentColor" className="text-muted"></path>
                <path
                    d="M300.11,339.35l-2.27-6.05a12.63,12.63,0,0,1,2.1-.08l2,6.57S300.53,339.14,300.11,339.35Z"
                    fill="currentColor" className="text-muted"></path>
                <path d="M293.19,342.88l-4.37-4.42a27.16,27.16,0,0,1,2.61-2.6l2.33,6.21Z"
                    fill="currentColor" className="text-muted"></path>
                <path
                    d="M287,351.07l6.4,18.73a13.26,13.26,0,0,0,16.82,8.25h0a13.25,13.25,0,0,0,8.25-16.83l-6.51-19.05a13.25,13.25,0,0,0-18.22-7.68A13.46,13.46,0,0,0,287,351.07Zm11.12-11.65a7.23,7.23,0,0,1,8,4.88l6.31,18.44a7.24,7.24,0,0,1-3.5,8.89,7.08,7.08,0,0,1-9.79-4.06l-6.46-18.91A7.07,7.07,0,0,1,298.09,339.42Z"
                    fill="none"></path>
                ...
                <path
                    ...
                    fill="currentColor" className="text-muted"></path>
                <path
                    d="M278.91,278.86l-2.27-6.05a12.63,12.63,0,0,1,2.1-.08l2,6.58S279.33,278.65,278.91,278.86Z"
                    fill="currentColor" className="text-muted"></path>
                <path d="M272,282.39,267.62,278a27.16,27.16,0,0,1,2.61-2.6l2.33,6.22Z" fill="currentColor" className="text-muted"></path>
                <path
                    d="M265.65,290.25l6.52,19.06A13.26,13.26,0,0,0,289,317.56h0a13.25,13.25,0,0,0,8.25-16.83l-6.51-19.05a13.25,13.25,0,0,0-25.08,8.57Zm10.23-11.05a7.07,7.07,0,0,1,9,4.4l6.46,18.91a7.06,7.06,0,1,1-13.37,4.57l-6.46-18.91A7.06,7.06,0,0,1,275.88,279.2Z"
                    fill="none"></path>
                <path
                ...
                <g className="opacity-40">
                    <path
                        d="M287.61,269.91l-4.67,3.32a13.34,13.34,0,0,1-3.14,18.58l-14.27,10.06,3.33,4.67,14.26-10.06A19.07,19.07,0,0,0,287.61,269.91Z"></path>
                </g>
                <path
